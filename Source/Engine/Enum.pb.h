...
enum MoveState : int {
  ...
  MOVE_STATE_RUN = 2,
  MOVE_STATE_DASH = 3,
  MOVE_STATE_SKILL_Q = 4,
  MOVE_STATE_SKILL_E = 5,
  MOVE_STATE_SKILL_R = 6,
  MOVE_STATE_SKILL_MOUSE_R = 7,
  MOVE_STATE_SKILL_MOUSE_L = 8,
...
constexpr MoveState MoveState_MAX = MOVE_STATE_SKILL_MOUSE_L;
