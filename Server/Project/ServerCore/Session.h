...
public:
	...
	CSessionRef			GetSessionRef() { return std::static_pointer_cast<CSession>(shared_from_this()); }
...
public:
	...
	CPacketSessionRef	GetPacketSessionRef() { return std::static_pointer_cast<CPacketSession>(shared_from_this()); }
