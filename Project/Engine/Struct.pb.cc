...
const char descriptor_table_protodef_Struct_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\r\022(\n\005state\030\002 \001(\0162\031.Protocol.EGameObjectT"
  "ype\022#\n\010pos_info\030\003 \001(\0132\021.Protocol.PosInfo"
  "b\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_Struct_2eproto = {
    false, false, 208, descriptor_table_protodef_Struct_2eproto,
    "Struct.proto",
...
PosInfo::PosInfo(const PosInfo& from)
  ...
  ::memcpy(&_impl_.object_id_, &from._impl_.object_id_,
    ...
    reinterpret_cast<char*>(&_impl_.object_id_)) + sizeof(_impl_.y_));
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          CHK_(ptr);
          _internal_set_state(static_cast<::Protocol::EGameObjectType>(val));
        } else
          goto handle_unusual;
        continue;
