...
int CDevice::Init()
{
	...
	if (FAILED(m_GraphicsDescHeap->Init(30000)))
		return E_FAIL;
	...
	CreateConstantBuffer(CBV_REGISTER::b1, sizeof(TransformParams), 300000);
	CreateConstantBuffer(CBV_REGISTER::b2, sizeof(MaterialParams), 300000);
