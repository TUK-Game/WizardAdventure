...
int CRootSignature::CreateRootSignature()
{
	...
	if (FAILED(DEVICE->CreateRootSignature(0, blobSignature->GetBufferPointer(), blobSignature->GetBufferSize(), IID_PPV_ARGS(&m_Signature))))
		return E_FAIL;
